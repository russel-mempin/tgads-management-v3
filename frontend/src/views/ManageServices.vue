...
<template>
	<ServiceForm v-model:isVisible="isVisible" @saved="fetchServices" :editData="editingData"
		@update:isVisible="onClose" />
	<ConfirmDialog>
		<template #icon>
	...
	<div class="mx-12 my-6 flex flex-col h-full min-h-0 overflow-hidden">
		<section class="flex justify-between items-center">
			<HeaderTitle 
				...
				subtitle="Configure the services that users can select when creating job orders."
			/>
