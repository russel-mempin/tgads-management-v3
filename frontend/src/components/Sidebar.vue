...
const allItems = computed<NavItem[]>(() => [
  ...
  },
  {
    ...
    badge:
      forReviewStore.count > 99
        ? '99+'
        : forReviewStore.count > 0
          ? String(forReviewStore.count)
          : undefined
  },
  ...
  { to: '/expenses', label: 'Expenses', icon: 'i-lucide-banknote-arrow-down', category: authStore.isOwner ? 'Finances' : 'Operations' },
